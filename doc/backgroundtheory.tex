...
given as $a(t)=\frac{d^2r(t)}{dt}$ and the velocity $v(t)=\frac{dr(t)}{dt}$.
...
timestep. With this we can also discretize our spatial variables as 
By a Taylor expansion around $t_n$, one can approximate the time solution at
timestep $t=t_n+\Delta t$ giving
\begin{equation}
...
the solution, as can be seen from the taylor expansion,
$\epsilon\sim\mathcal{O}(\Delta t^2)$.
